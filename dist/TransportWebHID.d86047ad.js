...
})({"5yhkJ":[function(require,module,exports) {
"use strict";
 ...
 */ var TransportWebHID = /** @class */ function(_super) {
    ...
    function TransportWebHID1(device) {
        ...
        _this1.deviceModel = typeof device.productId === "number" ? (0, _devices.identifyUSBProductId)(device.productId) : undefined;
...
var devices = (_a = {}, _a[DeviceModelId.blue] = {
    ...
    getBlockSize: function(firmwareVersion) {
        var _a1;
        return (0, _semverDefault.default).lt((_a1 = (0, _semverDefault.default).coerce(firmwareVersion)) !== null && _a1 !== void 0 ? _a1 : "", "2.0.0") ? 4096 : 2048;
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5yhkJ"], null, "parcelRequirea48b")
